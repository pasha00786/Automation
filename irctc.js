//Developed by Ashutosh Gupta and RishiKant Rajpoot using Puppeteer.
const puppeteer = require('puppeteer');
var request = require("request");
var readline = require('readline-sync');
const BrowserTimeOut=300000; 
     var username = 'ASHU1999'//readline.question("Please enter your irctc account USERNAME\n");
     var password = 'Aol360'//readline.question("Please enter your PASSWORD to login\n");
      var j_from ='NDLS'//readline.question("Enter the Origin(From) Station name or Code\n").toUpperCase();
      var j_to ='KGP'//readline.question("Enter the Destination Name or Code!\n").toUpperCase();
      var j_date ="26-06-2018"//readline.question("Enter the date of journey in 'DD-MM-YYYY' format!\n");
       ...
       async function choosetrain(page, quota)
            { 
               if(quota==1){
                            ...
                            await clickByText(page, `ANVT HLZ S F EXP`);
                           }
